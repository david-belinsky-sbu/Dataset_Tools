...
patch_size_40X = int(sys.argv[4]); #2100      # 350*8 --> 8*8 smaller non-overlap patches (350x350)
level = 0
...
try:
    ...
    mpp = oslide.properties[openslide.PROPERTY_NAME_MPP_X]
except:
...
def extract_patch(corr):
    ...
    fname = '{}/{}_{}_{}_{}_{}_{}_{}.png'.format(output_folder, x, y, pw_x, pw_y, mpp, width, height)
